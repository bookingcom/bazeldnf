...
tar --file $ARCHIVE_TMP --delete ${PREFIX}/bazeldnf/private/integrity.bzl
...
tar --file $ARCHIVE_TMP --append ${PREFIX}/bazeldnf/private/integrity.bzl
...
http_archive(
    ...
    sha256 = "${SHA}",
    strip_prefix = "${PREFIX}",
    url = "https://github.com/rmohr/bazeldnf/releases/download/${TAG}/${ARCHIVE}",
)
